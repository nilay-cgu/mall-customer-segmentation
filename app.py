...
AI Training Capstone Project – Customer Behavior Analysis
</p>
</div>
""", unsafe_allow_html=True)
    ...
    col3.markdown("<div class='metric-box'><b>Learning</b><br>Unsupervised</div>",unsafe_allow_html=True)

    st.markdown("## Introduction")

    st.markdown("""
<div class="card">
Customer segmentation helps businesses understand customer behavior by grouping customers based on income and spending patterns.
</div>
""", unsafe_allow_html=True)
...
# ---------------- INSIGHTS ----------------
    ...
    st.markdown("""
<div class="card">
Customer segmentation allows businesses to target premium, moderate, and low-spending customers with different marketing strategies.
</div>
""", unsafe_allow_html=True)
